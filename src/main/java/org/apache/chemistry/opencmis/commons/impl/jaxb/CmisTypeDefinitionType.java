...
@XmlSeeAlso({
    ...
    CmisTypeDeltaFunctionsDefinitionType.class,
    CmisTypeDeltaFunctionDefinitionType.class,
    CmisTypeDeltaSeriesDefinitionType.class,
    CmisTypeDeltaCaseFileDefinitionType.class,
    CmisTypeDeltaVolumeDefinitionType.class,
    CmisTypeDeltaCaseDefinitionType.class,
